...
function showFullscreenDialog(div) {
    ...
    div.center();
    div.show();
    $('#backgroundFiller').die('click').on('click', function (e) {
        hideMsgBox();
    });
}
...
$(document).ready(function () {
    ...
    $('#subtitleTableBody tr > td').on('contextmenu', function (e) {
        if (e.which == 3) {
            e.preventDefault();
    ...
    $('#listviewContextMenu').on('mouseleave', function () {
        $('#listviewContextMenu').hide('fade');
    });
    $('#subtitleTableBody tr > td').on('click', function (e) {
        listViewChange($(this).parent(), e);
    });
    $('#subtitleTableBody tr > td').on('dblclick', function (e) {
        var tr = $(this).parent();
    ...
    $('#currentText').on('keyup', function (e) {
        currentTextChange();
    });
    ...
    $('#lineDelete').on('click', function (e) {
        $('#listviewContextMenu').hide('fade');
    ...
    $('#timeLineDelete').on('click', function (e) {
        $('#timeLineContextMenu').hide('fade');
    ...
    $('#lineInsertBefore').on('click', function (e) {
        $('#listviewContextMenu').hide('fade');
        if (currentTr == null)
            return;
    ...
    $('#timeLineInsertBefore').on('click', function (e) {
        $('#timeLineContextMenu').hide('fade');
        timeLineContextMenuIndex = -1;
        if (currentTr == null)
            return;
    ...
    $('#lineInsertAfter').on('click', function (e) {
        $('#listviewContextMenu').hide('fade');
        if (currentTr == null)
            return;
        var target = getParagraphFromTr(currentTr);
    ...
    $('#timeLineInsertAfter').on('click', function (e) {
        $('#timeLineContextMenu').hide('fade');
        timeLineContextMenuIndex = -1;
        if (currentTr == null)
            return;
    ...
    $('#lineMergeWithNext').on('click', function (e) {
        $('#listviewContextMenu').hide('fade');
        if (currentTr == null)
            return;
    ...
    $('#timeLineMergeWithNext').on('click', function (e) {
        $('#timeLineContextMenu').hide('fade');
        mergeWithNext(timeLineContextMenuIndex);
        timeLineContextMenuIndex = -1;
    });
    $('#timeLineInsertHere').on('click', function (e) {
        $('#timeLineContextMenu').hide('fade');
        var start = timeLineNewStart;
        var end = timeLineNewEnd;
        if (start > end) {
    ...
    $('#mainMenu ul > li').on('mouseover', function (e) {
        $(this).find("ul").css('left', $(this).offset().left + 'px');
        $(this).find("ul").show();
    });
    $('#mainMenu ul > li').on('mouseout', function (e) {
        $(this).find("ul").hide();
    });
    ...
    $('#syncShowEarlierLater').on('click', function (e) {
        $(this).parent("ul").hide();
        showFullscreenDialog($("#syncMenuShowEarlierLater"));
    });

    $('#syncChangeFrameRate').on('click', function (e) {
        $(this).parent("ul").hide();
        showFullscreenDialog($("#syncMenuChangeFrameRate"));
    });
    $('#buttonChangeFrameRate').on('click', function (e) {
        hideMsgBox();
    ...
    $('#doGoogleTranslate').on('click', function (e) {
        var x = $("#iframeGT");
        if (x != "undefined")
            x.remove();
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function (data) {
                $("#translateIframe").html('<iframe id="iframeGT" src="/SubtitleEdit/OnlineTranslate" style="width:100%; height:100%"></iframe>');
    ...
    $('#doBingTranslate').on('click', function (e) {
        var x = $("#iframeGT");
        if (x != "undefined")
            x.remove();
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function (data) {
                $("#translateBingIframe").html('<iframe id="iframeGT" src="/SubtitleEdit/OnlineTranslateBing" style="width:100%; height:100%"></iframe>');
    ...
    $('#optionsSettings').on('click', function (e) {
        showFullscreenDialog($("#optionsSettingsText"));
    });
    $('#settingCenterTimeLine').on('click', function (e) {
    ...
    $('#aboutHelp').on('click', function (e) {
        $(this).parent("ul").hide();
        showFullscreenDialog($("#helpText"));
    });
    $('#aboutAbout').on('click', function (e) {
        $(this).parent("ul").hide();
    ...
    $('#subtitleDownload').on('click', function (e) {
        $(this).parent("ul").hide();
        showFullscreenDialog($("#subtitleDownloadText"));
    });
    $('#subtitleDownloadOK').on('click', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $.ajax({
                    type: 'POST',
                    url: "/SubtitleEdit/OnlineUploadSubtitle",
                    data: JSON.stringify(subtitles),
                    contentType: "application/json; charset=utf-8",
                    dataType: 'json',
                    success: function (data) {
    ...
    $('#buttonShowEarlierLaterDone').on('click', function (e) {
        hideMsgBox();
    });
    $('#buttonShowEarlier').on('click', function (e) {
    ...
    $('#buttonShowLater').on('click', function (e) {
        var adjustSeconds = parseFloat($('#showEarlierLaterSeconds').html());
        var len = subtitles.length;
        for (var i = 0; i < len; i++) {
            var sub = subtitles[i];
